...
Espo.define('project-management:acl-portal/issue', 'acl-portal', function (Dep) {
    ...
    return Dep.extend({
        ...
        checkInAccount: function (model) {
            ...
            if (model.get('projectAccountId')) {
                if (~accountIdList.indexOf(model.get('projectAccountId'))) {
                    return true;
                }
            }
