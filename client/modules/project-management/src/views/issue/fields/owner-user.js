...
Espo.define('project-management:views/issue/fields/owner-user', ['views/fields/owner-user', 'project-management:views/fields/link'],
    (Dep, Link) => {
        ...
        return Dep.extend({
            ...
            setup: function () {
                ...
                this.listenTo(this.model, 'change:projectId', () => {
                    this.model.set('ownerUserId', null);
                    this.model.set('ownerUserName', null);
                });
            },
